...
def identity_steps():
    ...
    2. For each step, create a subgraph in DOT syntax (e.g., 'subgraph cluster_X {{ label="1.Step Name" }}')., keep the number in front of the step name
...
if __name__ == "__main__":
    ...
    #print('=======================================================')
    combine_dot_code = combine_dot_code(dot_code_output_step3, relations)
    print(combine_dot_code)
    with open("combined_graph.txt", "w") as f:
        f.write(combine_dot_code)

    # print("DOT graph written to combined_graph.txt")
   # complete_dot_code = complete_dot_code(combine_dot_code)
  # beatified_dot_code = beatify_dot_code(complete_dot_code)
    
#    print("Generated DOT code for step 1:\n", dot_code_output_step1)
 #   print("Generated DOT code for step 2:\n", step_details)
  #  print("Generated DOT code for step 3:\n", dot_code_output_step3)
   # print("Combine dot code\n", combine_dot_code)
  #  print("Complete dot code\n", complete_dot_code)
   # print("Beatified dot code\n", beatified_dot_code)
